...
export const MANAGED_TEMPLATE_TRIAL_MESSAGE_LIMIT_ERROR =
  "This hosted demo has a 5 message limit. Deploy your own copy to unlock the full Agents OSS template.";
export const MANAGED_TEMPLATE_TRIAL_SESSION_LIMIT_ERROR =
  "This hosted demo includes 1 trial session. Deploy your own copy to unlock the full Agents OSStemplate.";
...
export const MANAGED_TEMPLATE_TRIAL_CODE_EDITOR_ERROR =
  "The code editor is disabled in the hosted demo. Deploy your own copy to unlock the full Agents OSStemplate.";
