...
- `createEditDiffLines` from `@agents-oss/shared/lib/diff` - adapt for unified diff parsing
...
- `@agents-oss/sandbox` for `connectVercelSandbox`
- `@agents-oss/shared/lib/diff` for diff utilities
